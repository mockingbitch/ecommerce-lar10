                                        ...
                                        <div class="product-body">
                                            ...
                                            <div class="product-btns">
                                                ...
                                                <button class="quick-view"><i class="fa fa-eye"></i><span class="tooltipp">
                                                    <a style="color: white" href="{{route(RouteConstant::HOME_PRODUCT_DETAIL, ['id' => $product->id])}}">Xem nhanh</a></span></button>
                                            </div>
                                        </div>
                                        <div class="add-to-cart">
                                            <a href="{{route(RouteConstant::HOME_PRODUCT_DETAIL, ['id' => $product->id])}}"><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>Xem chi tiết</button></a>
                                        </div>
                                    </div>
                                @endforeach
                            <!-- /product -->
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-btns">
                                            <button class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">add to wishlist</span></button>
                                            <button class="add-to-compare"><i class="fa fa-exchange"></i><span class="tooltipp">add to compare</span></button>
                                            <button class="quick-view"><i class="fa fa-eye"></i><span class="tooltipp"><a href="">Xem nhanh</a></span></button>
                                        </div>
                                    </div>
                                    <div class="add-to-cart">
                                        <a href="{{route(RouteConstant::HOME_PRODUCT_DETAIL, ['id' => $product->id])}}"><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>Xem chi tiết</button></a>
